    ...
    <div className="relative bg-white text-gray-800 dark:bg-gray-900 dark:text-white">
      <div className="container mx-auto px-6 py-28 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="md:w-1/2 mb-8 md:mb-0 text-center md:text-left">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 text-teal-600 dark:text-teal-400">Adem Bouteraa</h1>
          <h2 className="text-xl md:text-2xl mb-4 text-gray-600 dark:text-gray-300">Business Intelligence Professional</h2>
        ...
        <div className="md:w-1/3">
          <img
            src={profilePic}
            alt="Adem Bouteraa"
            className="rounded-full w-72 h-72 object-cover shadow-xl border-8 border-white dark:border-gray-700"
          />
        </div>
      </div>
    </div>
