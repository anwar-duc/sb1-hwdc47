...
export const Education = () => {
  return (
    <div className="container mx-auto px-6 py-20">
      <h2 className="text-3xl font-bold mb-12 text-center text-teal-600 dark:text-teal-400">Education</h2> {/* Updated title color */}
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-xl transition-all">
          <div className="flex items-center mb-4">
            ...
            <div>
              <h3 className="text-xl font-bold mb-1 text-gray-800 dark:text-white">Higher School of Digital Economy, University of Manouba</h3>
              <p className="text-gray-600 dark:text-gray-300">Master's Degree in Monitoring and Competitive Intelligence | 2024 - Current</p>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-xl transition-all">
          <div className="flex items-center mb-4">
            ...
            <div>
              <h3 className="text-xl font-bold mb-1 text-gray-800 dark:text-white">Higher School of Digital Economy, University of Manouba</h3>
              <p className="text-gray-600 dark:text-gray-300">Bachelor’s Degree in E-Business | 2020 - 2024</p>
            </div>
          </div>
          <p className="text-gray-700 dark:text-gray-400">
